...
from ui.ResultDashBoard import ScrollableResultDashBoard
...
"")
        ...
        self.tab_3 = ScrollableResultDashBoard()
...
"")
        ...
        self.doubleSpinBox.setSingleStep(0.0010000000000000)
...
"")
        ...
        self.doubleSpinBox_2.setSingleStep(0.000100000000000000)
...
"Machine Learning Model", None))
    ...
    def connect(self, train):
        self.doubleSpinBox.valueChanged.connect(train.setLearningRate)
        self.doubleSpinBox_2.valueChanged.connect(train.setLearningRateDecay)
        self.radioButton.toggled.connect(lambda: train.setOptimizer(self.radioButton))
        self.radioButton_2.toggled.connect(lambda: train.setOptimizer(self.radioButton_2))
        self.radioButton_3.toggled.connect(lambda: train.setOptimizer(self.radioButton_3))
        self.radioButton_4.toggled.connect(lambda: train.setOptimizer(self.radioButton_4))
        self.radioButton_5.toggled.connect(lambda: train.setOptimizer(self.radioButton_5))
        self.radioButton_6.toggled.connect(lambda: train.setOptimizer(self.radioButton_6))
        self.radioButton_7.toggled.connect(lambda: train.setOptimizer(self.radioButton_7))
        self.radioButton_8.toggled.connect(lambda: train.setOptimizer(self.radioButton_8))
        self.radioButton_8.setChecked(True)
        self.doubleSpinBox.setValue(0.001)
        self.doubleSpinBox_2.setValue(1e-4)
